...
<body onload='getJobSizeData()' class="hold-transition skin-blue sidebar-mini"  style="overflow: scroll">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/processJS/jobSize.js"></script>
</html>