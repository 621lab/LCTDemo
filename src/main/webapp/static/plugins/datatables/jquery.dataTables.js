...
(/** @lends <global> */function( $ ) {
	...
	/**
	 * Create a mappers object that allows camel case parameters to be looked up
	 * for their Hungarian counterparts. The mappers is stored in a private
	...
	/**
	 * Get the data for a given cell from the internal cache, taking into account data mappers
	 *  @param {object} settings dataTables settings object
	...
	function _fnCreateTr ( oSettings, iRow, nTrIn, anTds )
	{
		...
		if ( row.nTr === null )
		{
			...
			/* Use a private property on the node to allow reserve mappers from the node
