...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
      ...
      + "<td><div class='self_right_icon' draggable='true' id='graph' style=' opacity:0.3;'><img id='right-icon' src='../../img/graph.svg'><label style='font-weight: 300;margin-left: 6%'>关系图</label></div></td></tr>"
      ...
      + "<tr><td><div class='self_right_icon' draggable='true' id='boxChart' style=' opacity:0.3;'><img id='right-icon' src='../../img/boxplot.svg'><label style='font-weight: 300;margin-left: 6%'>盒形图</label></div></td>"
