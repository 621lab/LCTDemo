...
<body  onload='getOptimizeData("GT-C021.P.001.01");getWorkingHoursAnalyzeData()' class="hold-transition skin-blue sidebar-mini"  style="overflow: scroll">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/workingHoursSelector.js"></script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/processJS/workingHours.js"></script>
</html>